		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#baitcongroupinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"baitcongroupinvoices-display": {
								"semanticObject": "baitcongroupinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=baitcongroup.invoices",
									"url": sap.ui.require.toUrl("baitcongroup/invoices")
								}
							}
						}
					}
